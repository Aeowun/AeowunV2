---
description: Aeowun design philosophy — the shared Values→Principles→Moves vocabulary for reasoning about UI in design terms rather than raw pixels. Use when creating, editing, or reviewing any visual surface (CSS, DOM, theming, icons, motion). Name the value/principle before reaching for a token.
...
- **Moves (the mechanics):** elevation tiers (Control 4 / Inner 6 / Outer 8;
  ...
  `--aeowun-*` theme color, reveal-on-intent chrome, prefer a word to a mystery
  glyph.
