---
description: Aeowun coding guidelines — naming, style, types, strings, and code quality rules. Reference when writing or reviewing code.
applyTo: src/vs/**
---

# Coding Guidelines

Aeowun follows the coding standards established by the foundation VS Code project, evolved for a local-first engineering experience.

Also see the [Source Code Organization](source-code-organization.instructions.md) instructions.
...
- Include Aeowun copyright header in all files
