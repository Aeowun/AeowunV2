---
description: Aeowun test writing guidelines — unit tests, integration tests, snapshot tests, and clean teardown patterns. Reference when writing or updating tests.
applyTo: "{src/vs/**/test/**,src/vs/**/*.test.ts,src/vs/**/*.integrationTest.ts}"
---

# Writing Tests

Aeowun follows the testing standards established by the foundation VS Code project.
...
- **Aeowun UI:** Use the Aeowun Selfhost Test Provider.
