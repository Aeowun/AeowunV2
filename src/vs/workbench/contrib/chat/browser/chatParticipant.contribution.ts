...
import { MagyChatViewPane } from './magyChatViewPane.js';
...
const chatViewDescriptor: IViewDescriptor = {
	...
	when: ContextKeyExpr.false() // SURGICAL HIDE: Chat View tab gone
};
Registry.as<IViewsRegistry>(ViewExtensions.ViewsRegistry).registerViews([chatViewDescriptor], chatViewContainer);

const magyChatViewIcon = registerIcon('magy-view-icon', Codicon.sparkle, localize('magyChatViewIcon', 'View icon of the MAGY view.'));

const magyChatViewContainer: ViewContainer = Registry.as<IViewContainersRegistry>(ViewExtensions.ViewContainersRegistry).registerViewContainer({
	id: 'workbench.panel.magy',
	title: { value: 'MAGY', original: 'MAGY' },
	icon: magyChatViewIcon,
	ctorDescriptor: new SyncDescriptor(ViewPaneContainer, ['workbench.panel.magy', { mergeViewWithContainerWhenSingleView: true }]),
	storageId: 'workbench.panel.magy',
	hideIfEmpty: true,
	order: 1,
}, ViewContainerLocation.AuxiliaryBar, { isDefault: true });

const magyChatViewDescriptor: IViewDescriptor = {
	id: MagyChatViewPane.ID,
	containerIcon: magyChatViewContainer.icon,
	containerTitle: magyChatViewContainer.title.value,
	singleViewPaneContainerTitle: magyChatViewContainer.title.value,
	name: { value: 'MAGY', original: 'MAGY' },
	canToggleVisibility: true,
	canMoveView: true,
	ctorDescriptor: new SyncDescriptor(MagyChatViewPane),
	when: ContextKeyExpr.true()
};
Registry.as<IViewsRegistry>(ViewExtensions.ViewsRegistry).registerViews([magyChatViewDescriptor], magyChatViewContainer);
