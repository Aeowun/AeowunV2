...
import { IMagyLifecycleMainService } from '../../platform/magy/common/magyLifecycleMainService.js';
import { MagyLifecycleMainService } from '../../platform/magy/electron-main/magyLifecycleMainService.js';
import { MagyLifecycleChannel } from '../../platform/magy/common/magyLifecycleIpc.js';
...
export class CodeApplication extends Disposable {
	...
	private async initServices(machineId: string, sqmId: string, devDeviceId: string, sharedProcessReady: Promise<MessagePortClient>): Promise<IInstantiationService> {
		...
		// Magy
		services.set(IMagyLifecycleMainService, new SyncDescriptor(MagyLifecycleMainService));
	...
	private initChannels(accessor: ServicesAccessor, mainProcessElectronServer: ElectronIPCServer, sharedProcessClient: Promise<MessagePortClient>): void {
		...
		// Magy
		mainProcessElectronServer.registerChannel('magy', new MagyLifecycleChannel(accessor.get(IMagyLifecycleMainService)));
